  ...
  return (
    <footer className="flex w-full flex-col items-center bg-white/10 text-center">
      <div className="flex items-center p-6">
        ...
        <div className="flex">
          <Link href='https://twitter.com/fer_tostado' className="mr-6 text-gray-600">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
          ...
          <Link href="https://www.linkedin.com/in/luis-fernando-gonz%C3%A1lez-tostado-a9696177/" className="mr-6 text-gray-600">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
          ...
          <Link href="https://github.com/esponges" className="text-gray-600">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
